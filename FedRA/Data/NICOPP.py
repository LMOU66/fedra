...
def get_nico_dloader(base_path, domain_name, batch_size, num_workers=16):
    ...
    train_dloader = DataLoader(train_dataset, batch_size=batch_size, num_workers=num_workers, pin_memory=True,
                               shuffle=True)
    test_dloader = DataLoader(test_dataset, batch_size=8, num_workers=num_workers, pin_memory=True,
                              shuffle=False)
    train_loader_p = DataLoader(train_dataset, batch_size=8, num_workers=num_workers, pin_memory=True,
                               shuffle=True)
...
def get_nico_dataset(base_path, domain_name, batch_size,alpha=0.01,clients_for_eachdomain=5,num_workers=8):
    ...
    # train_dloader = DataLoader(train_dataset, batch_size=batch_size, num_workers=num_workers, pin_memory=True,
    #                            shuffle=True)
    test_dloader = DataLoader(test_dataset, batch_size=16, num_workers=num_workers, pin_memory=True,
                              shuffle=False)
